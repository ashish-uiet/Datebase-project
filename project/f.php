...
<form action="" method="post">
  <fieldset>
    ...
    <h3 style="color:#9370DB">Username<input type="text" name="username">
    <br><br>Password <input type="password" name="password"></h3>
    <h4  style="color:red;text-align:LEFT">Oops.. Invalid username or password !!</h4>
    <h1><input type="Submit" name="login" value="   Log In    "></h1>
  </fieldset>
<?php
	session_start();
